...
if (__name__=="__main__"):
    ...
    try:
        ...
        while(1):
            ...
            pub_move_right.publish(control_speed) # publish the control speed.
            pub_move_left.publish(control_speed) # publish the control speed. 
        ...
        pub_front_right.publish(control_turn)
        pub_front_left.publish(control_turn)
        pub_rear_right_move.publish(control_speed)
        pub_rear_left_move.publish(control_speed)
        # twist = Twist()
